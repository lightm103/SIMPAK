                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered text-center">
                            ...
                            <tbody>
                                @foreach ($dataKendaraans as $item)
                                    <tr>
                    ...
                    <form action="{{ route('datakendaraan.store') }}" method="POST" id="tambahbarang"
                        ...
                        <div class="row">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="plat_nomer" id="nomorPlat"
                            ...
                            <div class="mb-3">
                                <label for="fotoKendaraanDinas" class="form-label">Pilih Foto Kendaraan Dinas</label>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="merek_kendaraan" id="merekKendaraan"
                                    placeholder="Masukkan Merek Kendaraan">
                            </div>
                            <div class="mb-3">
                                <label for="jenisKendaraan" class="form-label">Jenis Kendaraan</label>
                                <input type="text" class="form-control" name="jenis_kendaraan" id="jenisKendaraan"
