                  ...
                  <ul aria-expanded="false" class="collapse first-level">
                      <li class="sidebar-item">
                          <a href="{{ route('datakendaraan.index')}}" class="sidebar-link">
                              ...
                              <span class="hide-menu">Data Kendaraan Dinas</span>
                          </a>
                      </li>
                      <li class="sidebar-item">
                          <a href="{{ route('dataperangkat.index')}}" class="sidebar-link">
                              ...
                              <span class="hide-menu">Data Perangkat Elektronik</span>
                          </a>
                      </li>
                      ...
                      <li class="sidebar-item">
                          <a href="{{ route('pajak.index')}}" class="sidebar-link">
                              ...
                              <span class="hide-menu">Data Pajak</span>
                          </a>
                      </li>
                      <!-- Akhir menu Data Pajak -->
                  </ul>
              </li>
          </ul>
      </nav>
