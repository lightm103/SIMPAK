                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @foreach ($dataPerangkats as $dataPerangkat)
                            ...
                            <p>Foto Pengguna: <img src="{{ asset('storage/fotopengguna/' . $dataPerangkat->foto_pengguna)}}"
                                alt="" style=""
                                srcset=""></p>
                            <p>Foto Perangkat : <img
                                    src="{{ asset('storage/fotoperangkat/' . $dataPerangkat->foto_perangkat)}}"
                                    alt="" style=""
                                    srcset=""></p>
                            <hr>
                        @endforeach
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        @foreach ($dataKendaraans as $dataKendaraan)
                            ...
                            <p>Foto Pengguna: <img
                                    src="{{ asset('storage/fotokendaraan/' . $dataKendaraan->foto_kendaraan) }}"
                                    alt="" style=""
                                    srcset=""></p>
                            <p>Foto Kendaraan: <img
                                    src="{{ asset('storage/fotopengguna/' . $dataKendaraan->foto_pengguna)}}"
                                    alt="" style=""
                                    srcset=""></p>
                            <hr>
                        @endforeach
